...
exports.findBazelVersion = void 0;
const exec = __importStar(require("@actions/exec"));
const io = __importStar(require("@actions/io"));
const fs = __importStar(require("fs"));
function findBazelVersion(baseInstallDir, version) {
    if (!baseInstallDir) {
...
exports.findBazelVersion = findBazelVersion;
function _findBazelVersionForLinux(baseInstallDir, version) {
